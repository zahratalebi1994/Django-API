"""
Django settings for DashboardServer project.
...
SECRET_KEY = 'poak=go*z(@&j89pii8v5$_yf(j=p2)738$+-ll7plxswz20@t'
...
ROOT_URLCONF = 'DashboardServer.urls'
...
WSGI_APPLICATION = 'DashboardServer.wsgi.application'
